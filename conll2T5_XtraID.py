...
def convertConllToT5(file_path):
  ...
  # print(file_dir)
  if 'dev' in file_path:
    save_dir = file_pdir + '/processed_full_conll_XtraID/val/'
  elif 'test' in file_path:
    save_dir = file_pdir + '/processed_full_conll_XtraID/test/'
  elif 'train' in file_path:
    save_dir = file_pdir + '/processed_full_conll_XtraID/train/'
  else:
    raise ValueError(
