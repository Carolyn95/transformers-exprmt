...
class MyDataset(Dataset):
  ...
  def _build(self):
    self._build_examples_from_files(self.source_files, self.target_files)

  def _build_examples_from_files(self, source_files, target_files):
...
if __name__ == "__main__":
  ...
  paths = [
      't5_conll_1500_xtraid_new_envr_gpu_0',
      't5_base_conll_1500_xtraid_new_envr_gpu_0'
  ]  # [out_path, model_path]
  ...
  args_dict = dict(
      data_dir="./data/processed_1500_conll_XtraID/",  # path for data files
