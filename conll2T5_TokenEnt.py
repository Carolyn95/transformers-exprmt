...
#target:  Miss MISC Universe MISC
# 20201210
import pdb
import pandas as pd
import os
...
def convertConllToT5(file_path):
  ...
  # print(file_dir)
  if 'dev' in file_path:
    save_dir = file_pdir + '/processed_full_conll_TokenEnt/val/'
  elif 'test' in file_path:
    save_dir = file_pdir + '/processed_full_conll_TokenEnt/test/'
  elif 'train' in file_path:
    save_dir = file_pdir + '/processed_full_conll_TokenEnt/train/'
  else:
    raise ValueError(
